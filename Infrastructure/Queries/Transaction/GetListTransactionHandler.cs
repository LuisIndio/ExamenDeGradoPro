...
{
    internal class GetListTransactionHandler : IRequestHandler<GetListTransactionQuery, IEnumerable<TransactionDto>>
    {
        private readonly DbSet<TransactionReadModel>? transactions;

        public GetListTransactionHandler(ReadDbContext Context)
        {
